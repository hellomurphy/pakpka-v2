<template>
  <div>
    ...
    <div v-if="!hasHydrated" class="flex h-screen items-center justify-center bg-slate-50">
    ...
    <div v-else-if="!activeProperty" class="flex h-screen items-center justify-center bg-slate-50">
      <div class="text-center p-8 bg-white rounded-xl shadow-md">
        ...
        <BaseButton class="mt-6" variant="secondary" @click="signOut()">
    ...
    <div v-else class="flex h-screen bg-white">
      ...
      <div
        ...
        :class="[isSidebarOpen ? 'md:ml-72' : 'md:ml-0', 'lg:ml-72']"
      >
...
const { signOut, status } = useAppAuth()
