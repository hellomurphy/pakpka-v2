...
const optionalServiceCatalog = computed(() => {
  ...
  return serviceCatalog.value.filter(
    (s) => s.isOptional && !subscribedServiceIds.has(s.id)
  );
});
...
const handleAddService = () => {
  ...
  const selectedService = serviceCatalog.value.find(
    (s) => s.id === newServiceId.value
  );
  if (selectedService) {
    services.value.push({
    ...
    <dl class="divide-y divide-gray-100">
      ...
      <div class="py-3 sm:grid sm:grid-cols-3 sm:gap-4 sm:items-center">
        ...
        <dd class="sm:col-span-2">
          <div
            v-if="editingField !== 'rentAmount'"
            class="flex justify-between items-center"
          >
            <span class="text-sm text-gray-900"
              >{{ currency(values.rentAmount) }} / เดือน</span
            >
            <button
      ...
      <div class="py-3 sm:grid sm:grid-cols-3 sm:gap-4 sm:items-center">
        ...
        <dd class="sm:col-span-2">
          <div
            v-if="editingField !== 'depositAmount'"
            class="flex justify-between items-center"
          >
            <span class="text-sm text-gray-900">{{
              currency(values.depositAmount)
            }}</span>
            <button
      ...
      <div class="py-3 sm:grid sm:grid-cols-3 sm:gap-4 sm:items-center">
        ...
        <dd class="sm:col-span-2">
          <div
            v-if="editingField !== 'endDate'"
            class="flex justify-between items-center"
          >
            <span class="text-sm text-gray-900">{{
              fullDate(values.endDate)
            }}</span>
            <button
      ...
      <div class="py-3 sm:grid sm:grid-cols-3 sm:gap-4 sm:items-center">
        ...
        <dd class="col-span-2">
          <div
            v-if="editingField !== 'water'"
            class="flex justify-between items-center"
          >
            <div>
              <p class="text-sm text-gray-900">
                {{
                  values.waterBillingType === "FLAT_RATE"
                    ? "เหมาจ่าย"
                    : "ตามหน่วย"
                }}
              ...
              <p
                v-if="
                  values.waterBillingType === 'PER_UNIT' &&
                  values.waterMinimumCharge > 0
                "
      ...
      <div class="py-3 sm:grid sm:grid-cols-3 sm:gap-4 sm:items-center">
        ...
        <dd class="col-span-2">
          <div
            v-if="editingField !== 'electricity'"
            class="flex justify-between items-center"
          >
            <div>
              <p class="text-sm text-gray-900">
                {{
                  values.electricityBillingType === "FLAT_RATE"
                    ? "เหมาจ่าย"
                    : "ตามหน่วย"
                }}
      ...
      <div class="py-3 sm:grid sm:grid-cols-3 sm:gap-4">
        <dt
          class="text-sm font-medium text-gray-500 pt-2 flex items-start gap-2"
        >
        ...
        <dd class="sm:col-span-2 mt-1 sm:mt-0">
            ...
            >
              ...
              <div class="flex items-center gap-x-2">
                <span class="font-medium text-gray-900"
                  >{{ currency(service.price) }} / เดือน</span
                >
                <button
                  v-if="service.isOptional"
          ...
          <div
            ...
            class="mt-2 p-3 bg-slate-100 rounded-lg space-y-3"
          >
            <BaseSelect
            ...
            <div class="flex justify-end gap-x-2 pt-2">
              <BaseButton
                ...
                >ยกเลิก</BaseButton
              >
              <BaseButton @click="handleAddService" size="sm"
