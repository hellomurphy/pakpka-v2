  ...
  <BaseModal v-model="isModalOpen" maxWidth="lg">
    ...
    <div v-else-if="tenantHistory" class="mt-4 space-y-6">
      ...
      <div>
        ...
        <div class="mt-2 border-t border-gray-200 pt-3">
          <div
            v-if="
              !tenantHistory.contracts || tenantHistory.contracts.length === 0
            "
                    ...
                    <div class="min-w-0 flex-1">
                          ...
                          <span
                            ...
                            :class="{
                              'bg-gray-100 text-gray-700':
                                ct.contract.status === 'EXPIRED',
                              'bg-red-100 text-red-700':
                                ct.contract.status === 'TERMINATED',
                            }"
                          >
                            {{
                              ct.contract.status === "EXPIRED"
                      ...
                      <div class="mt-3 text-sm text-gray-700 space-y-3">
                        ...
                        >
                          ...
                          <p class="mt-1">
                            เหตุผล: {{ ct.contract.termination.reason }}
                          </p>
                        </div>
                        <div
                          v-if="
                            ct.contract.deposits &&
                            ct.contract.deposits.length > 0
                          "
                        ...
                        >
                          ...
                          <dl class="mt-1 text-xs grid grid-cols-3 gap-x-2">
                            ...
                            <dt class="text-slate-500 font-semibold">
                              ยอดคืนสุทธิ
                            </dt>
                        ...
                        >
                          ...
                          >
                            <span
                              >รอบบิล
                              {{ dayjs(invoice.period).format("MM/BB") }}</span
                            >
                            <span
                              class="font-semibold"
                              :class="
    ...
    <template #footer>
      <div class="w-full flex justify-end">
        <BaseButton @click="closeModal" variant="secondary">ปิด</BaseButton>
      </div>
    </template>
  </BaseModal>
</template>
