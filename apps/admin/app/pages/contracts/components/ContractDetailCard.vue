...
const saveField = async (field) => {
  ...
  const response = await contractsStore.updateContract(
    props.contract.id,
    payload
  );
  if (response.success) {
...
const cancelEdit = (field) => {
  ...
  if (field === "water") {
    ...
    editableContract.electricityBillingType =
      props.contract.electricityBillingType;
    editableContract.electricityRate = props.contract.electricityRate;
    editableContract.electricityMinimumCharge =
      props.contract.electricityMinimumCharge;
  } else {
    ...
    <div v-if="contract" class="border-t border-gray-200">
      <dl class="divide-y divide-gray-100">
        ...
        <div class="p-4 sm:p-6 grid grid-cols-3 gap-4 items-start">
          <dt
            class="text-sm font-medium text-gray-600 flex items-center gap-1.5 pt-2"
          >
          ...
          <dd class="col-span-2">
            ...
            >
              <div>
                <p class="text-sm text-gray-900">
                  {{
                    contract.waterBillingType === "FLAT_RATE"
                      ? "เหมาจ่าย"
                      : "ตามหน่วย"
                  }}
            ...
            <div v-else class="space-y-2">
              ...
              <div class="flex items-center gap-2">
                <CurrencyInput
                  v-model="editableContract.waterRate"
                  placeholder="ราคา"
                />
                <CurrencyInput
          ...
          <dd class="col-span-2">
            ...
            >
              <div>
                <p class="text-sm text-gray-900">
                  {{
                    contract.electricityBillingType === "FLAT_RATE"
                      ? "เหมาจ่าย"
                      : "ตามหน่วย"
                  }}
            ...
            <div v-else class="space-y-2">
              ...
              <div class="flex items-center gap-2">
                <CurrencyInput
                  v-model="editableContract.electricityRate"
                  placeholder="ราคา"
                />
                <CurrencyInput
