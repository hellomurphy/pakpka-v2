...
import { CurrencyInput, BaseInput, BaseSelect, BaseSwitch } from '~/components/form'
  ...
  <div v-if="settings" class="space-y-8">
    <div class="bg-white shadow-sm ring-1 ring-gray-900/5 sm:rounded-xl">
      <div class="px-4 py-5 sm:p-6">
        <h3 class="text-base font-semibold leading-7 text-gray-900">การตั้งค่ารอบบิล</h3>
        <p class="mt-1 text-sm text-gray-500">กำหนดวันตัดรอบและวันครบกำหนดชำระมาตรฐาน</p>
    ...
    <div class="bg-white shadow-sm ring-1 ring-gray-900/5 sm:rounded-xl">
      <div class="px-4 py-5 sm:p-6">
        ...
        <p class="mt-1 text-sm text-gray-500">กำหนดวิธีการคิดค่าน้ำ-ค่าไฟมาตรฐานสำหรับสัญญาใหม่</p>
    ...
    <div class="bg-white shadow-sm ring-1 ring-gray-900/5 sm:rounded-xl">
      <div class="px-4 py-5 sm:p-6">
        <h3 class="text-base font-semibold leading-7 text-gray-900">การตั้งค่าค่าปรับล่าช้า</h3>
        <div class="mt-4 space-y-4">
          ...
          >
            ...
            />
            <CurrencyInput v-model="settings.finance.lateFee.value" label="จำนวน" />
          </div>
        </div>
      </div>
    </div>
    <div class="bg-white shadow-sm ring-1 ring-gray-900/5 sm:rounded-xl">
      <div class="px-4 py-5 sm:p-6">
        <div class="flex justify-between items-center">
          ...
          <BaseButton :icon="PlusIcon" @click="openAddServiceModal"> เพิ่มบริการ </BaseButton>
        </div>
        ...
        <div class="mt-4 border-t border-gray-200">
          <table class="min-w-full divide-y divide-gray-200">
            ...
            <tbody class="divide-y divide-gray-100">
              <tr v-if="!settings.finance.services || settings.finance.services.length === 0">
