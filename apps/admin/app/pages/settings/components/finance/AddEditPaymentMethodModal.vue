...
const currentType = computed(() => (isEditMode.value ? props.method.type : props.addType))
...
<template>
  <BaseModal v-model="isModalOpen" max-width="lg" :persistent="true">
    ...
    <form id="payment-method-form" class="mt-6 space-y-4" @submit.prevent="onSubmit">
    ...
    <template #footer>
      <div class="w-full flex justify-end gap-x-3">
        <BaseButton variant="secondary" @click="closeModal"> ยกยกเลิก </BaseButton>
        <BaseButton type="submit" form="payment-method-form" :loading="store.isLoading">
