...
const progressPercentage = computed(() => {
  const { status, paidCount, totalInvoices, meterReadingRequired, meterReadingCompletedCount } =
    props.run
...
<template>
  ...
  >
    <div class="p-5">
      ...
      <div class="mt-4">
        <div class="flex justify-between text-sm font-medium text-slate-500 mb-1">
