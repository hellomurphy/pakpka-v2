...
const { isLoading, metrics, occupancy, billing, todos } =
  ...
  <div class="bg-white rounded-xl shadow-md min-h-full p-6 md:px-8">
    <header class="mb-6">
      ...
      <p class="mt-1 text-sm text-gray-600">
        นี่คือภาพรวมสุขภาพของหอพักคุณในวันนี้
      </p>
    </header>
    ...
    <div v-if="isLoading" class="space-y-6">
      ...
      <div class="grid grid-cols-1 gap-6 lg:grid-cols-3">
        ...
        >
          <div class="h-5 w-32 bg-gray-200 rounded mb-4 animate-pulse"></div>
          <div class="flex-1 flex items-center justify-center">
            <div class="w-48 h-48 bg-gray-200 rounded-full animate-pulse"></div>
          </div>
          <div class="grid grid-cols-3 gap-2 text-center mt-4">
            <div class="space-y-2">
              <div class="h-6 w-10 bg-gray-200 rounded mx-auto animate-pulse"></div>
              <div class="h-4 w-12 bg-gray-200 rounded mx-auto animate-pulse"></div>
            </div>
            <div class="space-y-2">
              <div class="h-6 w-10 bg-gray-200 rounded mx-auto animate-pulse"></div>
              <div class="h-4 w-12 bg-gray-200 rounded mx-auto animate-pulse"></div>
        ...
        <div class="lg:col-span-2 space-y-6">
          ...
          <!-- Skeleton: Todo List -->
          <div class="rounded-xl bg-white p-6 shadow-sm ring-1 ring-gray-900/5">
            <div class="h-5 w-48 bg-gray-200 rounded mb-4 animate-pulse"></div>
            <div class="space-y-2">
              <div
                v-for="n in 3"
                :key="n"
