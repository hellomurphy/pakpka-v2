  ...
  datasets: [
    {
      ...
      data: [
        ...
        props.occupancy.available,
        props.occupancy.other,
      ],
      borderWidth: 3,
  ...
  >
    ...
    <div class="my-auto flex items-center justify-center py-4">
      <div class="relative h-48 w-48">
        ...
        >
          <p class="text-3xl font-bold text-gray-900">{{ occupancy.total }}</p>
    ...
    <div class="grid grid-cols-3 gap-2 text-center">
      <div>
        <p class="font-semibold text-blue-600">{{ occupancy.occupied }}</p>
        <p class="text-gray-500">ไม่ว่าง</p>
      </div>
      <div>
        <p class="font-semibold text-green-600">{{ occupancy.available }}</p>
        <p class="text-gray-500">ว่าง</p>
      </div>
      <div>
        <p class="font-semibold text-amber-600">{{ occupancy.other }}</p>
