...
// เหตุผลที่พบบ่อย
const commonReasons = ['ยอดเงินไม่ถูกต้อง', 'สลิปไม่ชัดเจน', 'แนบสลิปซ้ำ', 'ไม่พบรายการ']
  ...
  <BaseModal v-model="isOpen" max-width="md">
    ...
    <template #footer>
      <div class="flex-1 flex justify-end gap-x-3">
        <BaseButton variant="secondary" @click="handleCancel"> ยกเลิก </BaseButton>
        <BaseButton variant="danger" @click="handleConfirm"> ยืนยันการปฏิเสธ </BaseButton>
      </div>
    </template>
  </BaseModal>
</template>
