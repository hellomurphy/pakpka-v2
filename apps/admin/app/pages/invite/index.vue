...
const downloadImage = async () => {
  ...
  if (selectedTab.value === "social" && socialComponent.value?.socialArea) {
    ...
    selectedTab.value === "print" &&
    printableComponent.value?.printableArea
  ) {
...
<template>
  <div v-if="isSessionInitialized" class="p-6 md:px-8 bg-white rounded-xl shadow-md min-h-full">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
      <div
        class="lg:col-span-2 flex justify-center items-start p-6 bg-slate-200/60 rounded-xl"
      >
      ...
      <div class="space-y-6">
        ...
        <div class="bg-white shadow-sm ring-1 ring-gray-900/5 rounded-xl">
          <div class="p-6">
            ...
            <p
              v-if="copied"
              class="text-sm text-green-600 mt-2 transition-opacity"
            >
              คัดลอกแล้ว!
            </p>
          </div>
