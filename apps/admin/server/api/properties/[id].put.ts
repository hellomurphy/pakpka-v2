...
const propertySettingsSchema = z.object({
  ...
  defaultElectricityBillingType: z.enum(Object.values(BillingType) as [string, ...string[]]).optional(),
...
export default defineEventHandler(async (event) => {
  try {
    ...
    if (body.data.roomNamingFormat !== undefined) updates.roomNamingFormat = body.data.roomNamingFormat
    if (body.data.roomTurnoverDays !== undefined) updates.roomTurnoverDays = body.data.roomTurnoverDays
    if (body.data.defaultWaterBillingType !== undefined) updates.defaultWaterBillingType = body.data.defaultWaterBillingType
    if (body.data.defaultWaterRate !== undefined) updates.defaultWaterRate = String(body.data.defaultWaterRate)
    if (body.data.defaultWaterMinimumCharge !== undefined) updates.defaultWaterMinimumCharge = String(body.data.defaultWaterMinimumCharge)
    if (body.data.defaultElectricityBillingType !== undefined) updates.defaultElectricityBillingType = body.data.defaultElectricityBillingType
    if (body.data.defaultElectricityRate !== undefined) updates.defaultElectricityRate = String(body.data.defaultElectricityRate)
    if (body.data.defaultElectricityMinimumCharge !== undefined) updates.defaultElectricityMinimumCharge = String(body.data.defaultElectricityMinimumCharge)
    ...
    if (body.data.defaultBillingCutoffDay !== undefined) updates.defaultBillingCutoffDay = body.data.defaultBillingCutoffDay
    if (body.data.defaultPaymentDueDays !== undefined) updates.defaultPaymentDueDays = body.data.defaultPaymentDueDays
